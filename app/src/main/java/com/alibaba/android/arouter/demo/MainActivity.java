    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.autoInject:
                ...
                break;
            case R.id.navByName:
                HelloService navigation = (HelloService) ARouter.getInstance().build("/yourservicegroupname/hello").navigation();
                navigation.sayHello("mike");
                break;
            case R.id.navByType:
                HelloService navigation1 = ARouter.getInstance().navigation(HelloService.class);
                navigation1.sayHello("mike");
                break;
            case R.id.navToMoudle1:
                ARouter.getInstance().build("/java/module/1").greenChannel().navigation();
                break;
            ...
            case R.id.getFragment:
                Fragment fragment = (Fragment) ARouter.getInstance()
                        .build("/test/fragment")
                        .withString("name","wangchao")
                        .withObject("obj",new TestObj("age",18))
                        .navigation();

                FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
                fragmentTransaction.add(R.id.ll_layout,fragment);
